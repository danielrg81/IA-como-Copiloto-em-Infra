...
| ENV_VARS | Variáveis de ambiente | TEXT=hello |
...
helm template test ./order-api-chart
helm install order-api ./order-api-chart -n ai-iac-lab --dry-run
helm install order-api ./order-api-chart -n ai-iac-lab
